...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUM] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, _______, MO(NUM),     _______,      MO(FN),  XXXXXXX, XXXXXXX, XXXXXXX, _______
    ),
    ...
    [NAV] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, MO(NAV), XXXXXXX,     _______,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______
    ),
    ...
    [KEB] = LAYOUT_planck_mit(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX,      XXXXXXX, MO(KEB), XXXXXXX, XXXXXXX, XXXXXXX
    ),
