...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_planck_mit(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO(NAV), MO(NUM),      KC_SPC,      MO(FN),  MO(KEB), MO(NAV), KC_DEL,  KC_RCTL
    ),
    ...
    [KEB] = LAYOUT_planck_mit(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, _______, _______,     XXXXXXX,      _______, _______, _______, XXXXXXX, XXXXXXX
    ),
